...
function Transaction() {
    ...
    const handleSubmission = async () => {
        ...
        try {
          ...
          const docRef = await addDoc(collection(db, 'transaction'), values);
    ...
    return (
        ...
        <div className="w-full mt-20 ">
          ...
          <div className=' lg:mx-96  mx-10 my-10 '>
            ...
            <p className='font-monste font-bold  text-4xl text-center mb-10'>Transaction Values</p>
          ...
          <div className='bg-white p-8 rounded-2.5xl'>
            ...
            <div class="space-y-6">
          <div>
            <p  class="text-start  font-lato text-sm font-medium  text-gray-900"> Address</p>
            <div class="mt-2">
          ...
          <div>
            <div class="flex items-center justify-between">
              <label for="password" class="block font-lato text-sm font-medium leading-6 text-gray-900">Amount</label>
             
            </div>
            <div class="my-2 ">
              <input id="password" name="password" type="number" autocomplete="current-password" required class=" p-3 border-1 rounded-xlg block w-full h-10 bg-admin-whiteSmokeLight placeholder:text-admin-whisper-1 "
          ...
          <div>
            <button type="submit" class="flex font-montse w-full text-white  h-10 justify-center rounded-xlg bg-black px-3 py-1.5 text-base font-bold disabled:!bg-gray-300 " onClick={handleSubmission} >Sign Up</button>
          </div>
